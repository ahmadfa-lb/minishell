...
void			handle_redirection_token(char **current,
					t_list_tokens **tokens);
void			handle_quoted_string_token(char **current,
					t_list_tokens **tokens);
void			handle_unquoted_word_token(char **current,
					t_list_tokens **tokens);
...
int				execute_cmds_in_childs(t_data *data, t_cmd *current_cmd,
					int num_pipes);
...
void			set_pipes(t_cmd *current_cmd, int **pipes, int i,
					int num_pipes);
...
int				open_and_duplicate(const char *filename, int flags, mode_t mode,
					int target_fd);
int				redirect(t_data *data, t_tokens_type token,
					t_list_tokens *tokens_list);
int				handle_redirections(t_data *data, t_cmd *current_cmd);
//-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
//parser
//cmd_list_manager.c
t_list_tokens	*remove_token(t_list_tokens **tokens_list,
					t_list_tokens *token);
void			append_cmd_tokens(t_cmd **cmd_list, t_list_tokens *head,
					t_list_tokens *last);
void			append_cmd_node(t_cmd **cmd_list, t_cmd *new_node,
					t_list_tokens *head, t_list_tokens *last);
...
//dollar_handling.c
void			handle_normal_variable(char *input, int *i, char **result,
					t_env *env);
...
bool			handle_redirection_error(t_list_tokens *next_token,
					t_data *data);
